...
public class Variant8 {
	 ...
	 *
	 * @param array
	 * @param n is count of columns of matrix
	 * @param m is count of rows of matrix
	 * @return transformed matrix where column with the number N and the first of the columns that contain only
	 * 			negative elements inverted. If there is no required columns then output matrix unchanged
	 */
	...
	public static void main(String... strings) {
		...
		System.out.println("I completed the task)))))");
